...
{
    public class SalesVoidReportControllerTest
    {
		protected SalesVoidReportController GetController(IIdentityService identityService, IValidateService validateService, ISalesDocService service)
		{
			...
			SalesVoidReportController controller = new SalesVoidReportController(identityService, validateService, service);
		...
		public void Get_Return_Data()
		{
			...
			//Act
			IActionResult response = GetController(identityService.Object, validateService.Object, service).Get(It.IsAny<string>(), It.IsAny<DateTimeOffset>(), It.IsAny<DateTimeOffset>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), "{}");
		...
		public void Get_Return_InternalException()
		{
			...
			IActionResult result = controller.Get(It.IsAny<string>(), It.IsAny<DateTimeOffset>(), It.IsAny<DateTimeOffset>(), It.IsAny<string>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<int>(), It.IsAny<string>());
